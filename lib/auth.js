...
async function getUserFromReq(req) {
  ...
  if (!user) return null;
  return { id: user.id, email: user.email, nome: user.nome, nomeSlug: user.nomeSlug };
}
...
/* ============================= ADMIN ============================= */
// A conta cujo e-mail bater com a variável de ambiente ADMIN_EMAIL vira
// administradora automaticamente — não existe um login separado, é a
// mesma conta normal, só com acesso extra.
